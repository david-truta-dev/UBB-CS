...
function loadScripts() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jenkins-js-load").each(function () {
    ...
    if (scriptUrl) {
      ...
      jenkins_js_modules__WEBPACK_IMPORTED_MODULE_1__.addScript(scriptUrl);
...
function loadCSS() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jenkins-css-load").each(function () {
    ...
    if (cssUrl) {
      ...
      // loaded once and once only. So, this can be considered
      // analogous to a client-side adjunct.
      jenkins_js_modules__WEBPACK_IMPORTED_MODULE_1__.addCSSToPage(cssUrl);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove();
    }
  });
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [216], function() { return __webpack_require__(66); })
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=page-init.js.map