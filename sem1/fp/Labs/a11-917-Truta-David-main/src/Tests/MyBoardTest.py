...
class MyBoardTest(TestCase):
    ...
    def test_check_good_coordinates_change_cell(self):
        self.__board.change_cell(Cell(0, 0, '.'))
        self.__board.change_cell(Cell(2, 3, 'x'))
        self.__board.change_cell(Cell(4, 7, '#'))
        self.assertTrue(self.__board.check_good_coordinates(Cell(0, 1)))
        self.assertTrue(self.__board.check_good_coordinates(Cell(5, 7)))
        self.assertFalse(self.__board.check_good_coordinates(Cell(0, 0)))
        self.assertFalse(self.__board.check_good_coordinates(Cell(2, 3)))
        self.assertFalse(self.__board.check_good_coordinates(Cell(4, 7)))

    def test_check_hit(self):
        self.__board.change_cell(Cell(0, 0, ' '))
        self.__board.change_cell(Cell(2, 3, '*'))
        self.__board.change_cell(Cell(4, 7, '0'))
        self.assertTrue(self.__board.check_hit(Cell(4, 7)))
        self.assertFalse(self.__board.check_hit(Cell(2, 3)))
        self.assertFalse(self.__board.check_hit(Cell(0, 0)))
    ...
    def test_check_empty(self):
        ...
        self.__board.change_cell(Cell(2, 3, '*'))
        self.__board.change_cell(Cell(4, 7, '0'))
        self.assertTrue(self.__board.check_empty(Cell(0, 0)))
        self.assertTrue(self.__board.check_empty(Cell(1, 1)))
        self.assertFalse(self.__board.check_empty(Cell(2, 3)))
        self.assertFalse(self.__board.check_empty(Cell(4, 7)))
