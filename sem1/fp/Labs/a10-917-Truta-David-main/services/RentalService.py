...
class RentalService:
    ...
    def __init__(self, rent_repo, book_repo, client_repo):
    ...
    def most_rented_book(self):
        ...
        books = IterableDataStructure.gnome_sort(books, self.times_rented_book, True)
        return books
    ...
    def most_active_client(self):
        ...
        if not clients:
            raise IndexError('The list is empty!')
        clients = IterableDataStructure.gnome_sort(clients, self.times_rented_client, True)
        # uses gnomeSort
        return clients
    ...
    def most_rented_author(self):
        ...
        books = IterableDataStructure.gnome_sort(books, self.times_rented_author, True)
        while i < len(books):
            book = books[i]
