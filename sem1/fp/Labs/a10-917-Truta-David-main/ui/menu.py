...
class Menu:
    ...
    def ui_generate_new(self):
        ...
        RedoManager.clear_redoes()
        self.__rental_service.remove_all_rentals()
        self.__client_service.remove_all_clients()
        self.__book_service.remove_all_books()
        self.__book_service.default_books(10)
        self.__client_service.default_clients(10)
        self.__rental_service.default_rentals(5)
        print('New set of data was generated!')
