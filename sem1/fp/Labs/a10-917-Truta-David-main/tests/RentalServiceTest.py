...
from repositories.inMemoryRepo import MemoryRentRepo, MemoryBookRepo, MemoryClientRepo
...
class RentalServiceTest(TestCase):
    ...
    def setUp(self):
        r_rep, b_rep, c_rep = MemoryRentRepo(), MemoryBookRepo(), MemoryClientRepo()
        self._r_service = RentalService(r_rep, b_rep, c_rep)
        self._b_service = BookService(b_rep)
        self._c_service = ClientService(c_rep, r_rep, b_rep)
        self._b_service.default_books(20)
        self._c_service.default_clients(20)
