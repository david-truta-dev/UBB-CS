...
public class MatrixHelper {
    ...
    public static void computeMultiplicationResultElements (int startIndex, int k, List<List<Integer>> firstMatrix, List<List<Integer>> secondMatrix, List<List<Integer>> resultMatrix){
